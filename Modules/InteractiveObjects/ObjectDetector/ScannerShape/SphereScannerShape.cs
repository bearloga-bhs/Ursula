...
class SphereScannerShape : IScannerShape
{
    ...
    /// </summary>
    public SphereScannerShape(Vector3 center, float radius)
    {
        this.center = center;
        this.radius = radius;
    }
    ...
    /// </summary>
    public SphereScannerShape(Vector3 center, float radius, Node3D relativeTo) : this(center, radius)
    {
        anchor = relativeTo;
        relative = true;
    }
